...
RUN apt update -y
RUN apt-get install -y git vim build-essential gcc-arm-linux-gnueabi g++-arm-linux-gnueabi scons swig m4 libgoogle-perftools-dev zlib1g zlib1g-dev python-dev
